export const seforim = ["בראשית","שמות","ויקרא","במדבר","דברים"];
export const aliyanames=["ראשון","שני","שלישי","רביעי","חמישי","שישי","שביעי","מפטיר"];
export const parshios={"בראשית":
